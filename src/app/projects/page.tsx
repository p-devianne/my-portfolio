        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-xl text-gray-600 dark:text-gray-400">
              A showcase of my technical projects and software development work
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50 dark:bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {['C++', 'Python', 'PyTorch', 'Reinforcement Learning', 'Deep Learning', 'Monte Carlo', 'Object-Oriented Programming', 'Google Test', 'Git', 'Data Analysis', 'Machine Learning'].map((skill) => (
              <span
                key={skill}
                className="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium bg-indigo-100 text-indigo-800 dark:bg-indigo-900 dark:text-indigo-200"
              >
                {skill}
              </span>
            ))}
